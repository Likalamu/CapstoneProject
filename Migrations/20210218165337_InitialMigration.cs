    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.UniqueConstraint("AK_EventCategory_TempId", x => x.TempId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.UniqueConstraint("AK_Tag_TempId", x => x.TempId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.UniqueConstraint("AK_Event_TempId", x => x.TempId);
                    table.ForeignKey(
